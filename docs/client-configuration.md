...
|--------------------------|------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| url                      |                                          | `valkey[s]://[[username][:password]@][host][:port][/db-number]` (see [`valkey`](https://www.iana.org/assignments/uri-schemes/prov/valkey) and [`valkeys`](https://www.iana.org/assignments/uri-schemes/prov/valkeys) IANA registration for more details) |
...
| socket.port              | `6379`                                   | Valkey server port                                                                                                                                                                                                                                   |
| socket.host              | `'localhost'`                            | Valkey server hostname                                                                                                                                                                                                                               |
...
| username                 |                                          | ACL username ([see ACL guide](https://valkey.io/topics/acl))                                                                                                                                                                                         |
| password                 |                                          | ACL password or the old "--requirepass" password                                                                                                                                                                                                    |
| name                     |                                          | Client name ([see `CLIENT SETNAME`](https://valkey.io/commands/client-setname))                                                                                                                                                                      |
| database                 |                                          | Valkey database number (see [`SELECT`](https://valkey.io/commands/select) command)                                                                                                                                                                    |
...
| readonly                 | `false`                                  | Connect in [`READONLY`](https://valkey.io/commands/readonly) mode                                                                                                                                                                                    |
| legacyMode               | `false`                                  | Maintain some backwards compatibility (see the [Migration Guide](./v3-to-v4.md))                                                                                                                                                                    |
| isolationPoolOptions     |                                          | See the [Isolated Execution Guide](./isolated-execution.md)                                                                                                                                                                                         |
| pingInterval             |                                          | Send `PING` command at interval (in ms). Useful with ["Azure Cache for Valkey"](https://learn.microsoft.com/en-us/azure/azure-cache-for-valkey/cache-best-practices-connection#idle-timeout)                                                          |
